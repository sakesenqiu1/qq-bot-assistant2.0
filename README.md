...
> - **v0.6 禁言去重修复（按人结清，不再依赖 AI 引用匹配）+ /群分析（结合人设与群规知识库输出管理建议）**
...
- **/查违规**：AI 按「色情（重点）/ 违法不实（重点）/ 辱骂 / 广告 / 刷屏 / 其他」审查今天的群消息记录并公示，报告含涉事人、类型、严重度、原话摘要与禁言执行结果
